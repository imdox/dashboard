                ...
                <div class="portfolio-gallery">
                    <div class="item" data-id="Image">
                        <div class="inner" style="height:100%;">
                            <img  style="object-fit: cover;"  src="assets/images/blog/1.jpg" alt="Avatar" onclick="openModal('1-myModal')" >
                            <div>
                                <p style="color:#000;"><strong>Title Msg</strong></p>
                            ...
                            <div class="mainImg">
                                <img src="assets/images/blog/1.jpg" style="height: 100%;object-fit: cover;"  alt="Avatar" class="image" >                          
                            </div> 
                            <div onclick="openModal('1-myModal')">
                                <div>
                                    <p style="color:#fff;"><strong>Title Msg</strong></p>
                     ...
                     <div class="item" data-id="Image" style="height:300px;">
                        <div class="inner" style="height:100%;">
                        <img class="myImg image"  style="height: 100%;object-fit: cover;"  src="assets/images/blog/2.jpeg" alt="Avatar" onclick="openModal('2-myModal')" >
                            <!-- The Modal -->
                             <div class="overlay">
                                <div class="text">Hello World fsfsfsdfsdfdsfs</div>
                            </div>            
                            <div id="2-myModal" class="modal">
                                <span class="close" onclick="closeModal('2-myModal')">&times;</span>
                                <img class="modal-content" src="assets/images/blog/2.jpeg" id="img01">
                                
                            </div>
                        </div>
                    </div>

                    <div class="item" data-id="Video" style="height:300px;">
                        <div class="inner" style="height:100%;">
                        <img class="myImg image"  style="height: 100%;object-fit: cover;"  src="assets/images/blog/3.jpg" alt="Avatar" onclick="openModal('3-myModal')" >
                            <!-- The Modal -->
                    ...
                    <div class="item" data-id="Video" style="height:300px;">
                        <div class="inner" style="height:100%;">
                        <img class="myImg image"  style="height: 100%;object-fit: cover;"  src="assets/images/blog/4.jpg" alt="Avatar" onclick="openModal('4-myModal')" >
                            <!-- The Modal -->
                    ...
                    <div class="item" data-id="Video" style="height:300px;">
                        <div class="inner" style="height:100%;">
                        <img class="myImg image"   style="height: 100%;object-fit: cover;" src="assets/images/blog/5.jpg" alt="Avatar" onclick="openModal('5-myModal')" >
                            <!-- The Modal -->
                    ...
                    <div class="item" data-id="Video" style="height:300px;">
                        <div class="inner" style="height:100%;">
                        <img class="myImg image"   style="height: 100%;object-fit: cover;" src="assets/images/blog/6.jpeg" alt="Avatar" onclick="openModal('6-myModal')" >
                            <!-- The Modal -->
