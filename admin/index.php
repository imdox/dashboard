        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                   ...
                   <li> <a href="#" class="waves-effect"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Courses<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                        ...
                        <div class="white-box">
                            <div class="row row-in">
                                <div class="col-lg-3 col-sm-6 row-in-br">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i data-icon="E" class="linea-icon linea-basic"></i>
                                            <h5 class="text-muted vb">Company Courses</h5> </div>
                                ...
                                <div class="col-lg-3 col-sm-6 row-in-br  b-r-none">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="icon-basic-video linea-basic" data-icon="&#xe022;"></i>
                                            <h5 class="text-muted vb">Videos</h5> </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h3 class="counter text-right m-t-15 text-megna"><?php echo mysqli_num_rows($query_videos);?></h3> </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="progress">
                ...
                <div class="col-md-12 col-lg-6 col-sm-12">
                                ...
                                <table class="table ">
                                    ...
                                    <?php
                                             if (mysqli_num_rows($query_posts)==0) {
                                                 echo "<i style='color:brown;'>No Posts Yet :( Upload Company's first Course today! </i> ";
                                                    }
                                                    else
                                                ...
                                                {
                                                    $postid = $row["id"];
                                                    $sql2 = "SELECT * FROM videos WHERE blogid=$postid";
                                    ...
                                    ?>
                                       ...
                                       <a href="courses.php" class="btn btn-info btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">View All Courses</a>
                                     </div>
                        </div>
                    </div>
                    ...
                    <div class="white-box">
                            <div class="row sales-report">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6 ">
                                    <h1 class="text-right text-success m-t-20"><?php echo mysqli_num_rows($query_videos);?></h1> 
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table ">
                                    ...
                                    <?php
                                             if (mysqli_num_rows($query_videos)==0) {
                                                ...
                                                while (($row = mysqli_fetch_array($query_videos)) and ($counter < $max) )
                                                {
                                                    $postid = $row["id"];
                                        ...
                                        <tr>
                                           ...
                                           <td class="txt-oflo">'.$row["video"].'</td>
                                    ...
                                    ?>
                                       ...
                                       <a href="videos.php" class="btn btn-info btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">View All Videos</a>
                                     </div>
                        </div>
                    </div>
