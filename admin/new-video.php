  ...
  <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                   ...
                   <li> <a href="#" class="waves-effect active"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Courses<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Add Video</h3>
                            <!-- <p class="text-muted m-b-30 font-13"> (Password Update) </p> -->
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="functions/new_video.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-5">
                                                <input type="text" class="form-control" name="video" required/> </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-3 control-label">Select Course</label>
                                            <div class="col-xs-5">
                                                <select class="form-select" name="blogid">
                                                    <option selected>Select Course</option>
                                                    <?php while ($courses = mysqli_fetch_assoc($query)) {
                                                        echo "<option value='".$courses['id']."'>".$courses['title']."</option>";
                                                    } ?>
                                                </select> </div>
                                        </div>
    ...
    (function() {
        ...
        $('#exampleValidator').wizard({
            onInit: function() {
                $('#validation').formValidation({
                    ...
                    fields: {
                        ...
                        //     validators: {
                        //         notEmpty: {
                        //             message: 'The email title is required'
                        //         }
                        //         // emailAddress: {
                        ...
                        //     validators: {
                        //         notEmpty: {
                        //             message: 'The video thumbnail is required'
                        //         }
                        //         // emailAddress: {
                        //         //     message: 'The input is not a valid email address'
                        //         // }
                        ...
                        //     validators: {
                        //         notEmpty: {
                        //             message: 'The video link is required'
                        //         }
                        //         // emailAddress: {
                        //         //     message: 'The input is not a valid email address'
                        //         // }
            ...
            onFinish: function() {
                console.log($("#validation").serialize());
                $.post("functions/new_video.php", $("#validation").serialize()).done(function(resData) {
                    var txt = resData.toString();
