                        ...
                        <div class="white-box">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    $sql="SELECT * FROM courses WHERE id='$postid'";
                                ...
                                '<div class="col-lg-12 col-md-9 col-sm-8 col-xs-12 mail_listing">
                                    <div class="media m-b-30 p-t-20">
                                    	<h4 class="font-bold m-t-0">Title : '.$row["title"].'
                                        <i style="float:right; font-size:15px; color:orange;">Videos: '.mysqli_num_rows($query2).'</i>
                                        </h4>
                                        <hr>
                                        <a class="pull-left" href="#"></a>
                                        <div class="media-body"> <span class="media-meta pull-right">'.$row["date"].'</span>
                                            <h4 class="text-danger m-0">Author : '.$row["author"].'</h4></div>
                                        </div>
                                            ...
                                            <div id="responsive-modal'.$row["id"].'" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="functions/del_course.php" method="post">
