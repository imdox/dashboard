        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                   ...
                   <li><a href="inbox.php" class="waves-effect"><i data-icon=")" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Suggestion</span></a>
                    ...
                    <li><a href="users.php" class="waves-effect active"><i data-icon="n" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Site Users</span></a>
                    </li>
                    <li><a href="reg-user.php" class="waves-effect active"><i data-icon="n" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Event Users</span></a>
                    </li>
