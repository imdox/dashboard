        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Create New Course Post</h3>
                            <p class="text-muted m-b-30 font-13"> A Course contains the author, title and its content.</p>
                            <div id="exampleValidator" class="wizard">
                                ...
                                <form id="validation" class="form-horizontal" action="functions/new_course.php" method="post">
    ...
    (function() {
        ...
        $('#exampleValidator').wizard({
            ...
            onFinish: function() {
                ...
                $.post("functions/new_course.php", $("#validation").serialize()).done(function(resData) {
