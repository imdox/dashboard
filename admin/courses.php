                                    ...
                                    <div class="inbox-center">
                                            <?php  
                                                            ...
                                                            '<div class="alert alert-warning" >
                                                                 ...
                                                                 <strong>DELETED!! </strong><p> The Course has been successfully deleted.</p>
                                                            </div>'
                                                            ;
                                                        }
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <h4>Recent Courses (<b style="color: orange;"><?php echo mysqli_num_rows($query);?></b>)</h4>
                                                        <?php 
                                            ...
                                            <tbody>
                                             <?php
                                              ...
                                              echo
                                              '<tr>
                                                    <td class="hidden-xs"><a href="courses-details.php?id='.$row["id"].'" />'.$row["title"].'</td>
                                                    <td class="max-texts" style="white-space: none !important;"> <a style="white-space: none !important;" href="courses-details.php?id='.$row["id"].'" ><div>'.$row["content"].'</div></a></td>
                                                    </td>
                                                </tr>
                                                ';
