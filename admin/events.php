                        ...
                        <div class="white-box">
                            ...
                            <div class="row">
                                ...
                                ?>  
                                                        ...
                                                        <h4>Recent Events (<b style="color: orange;"><?php echo mysqli_num_rows($query);?></b>)</h4>
                            ...
                            <div class="table-responsive">
                                <table class="table ">
                                    <?php if (mysqli_num_rows($query)==0) {
                                        ...
                                        {
                                            $sql1 = 'SELECT title FROM courses where id = '.$row["course"];
                                            // echo $sql1;
                                            $query1 = mysqli_fetch_array(mysqli_query($connection, $sql1));
                                            $active = $row["active"] == 1 ? "True" : "False";
                                            echo '
                                                <tr>
                                                    <td class="txt-oflo"><a href="events-details.php?id='.$row["id"].'">'.$row["title"].'</a></td>
                                                   <td class="txt-oflo"><a href="#myModal" class="showmodal" data-toggle="modal" data-url="'.$row["link"].'"><img width="150" src="'.$row["image"].'" /></a></td>
                                                   <td>'.$active.'</td>
