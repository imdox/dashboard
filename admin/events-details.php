            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <a href="courses.php" class="waves-effect "><i data-icon="&#xe020;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Go Back</span></a>
                        ...
                        <div class="white-box">
                            <div class="row">
                                ...
                                <?php 
                                    ...
                                    $sql="SELECT * FROM events WHERE id='$postid'";
                                ...
                                '<div class="col-lg-12 col-md-9 col-sm-8 col-xs-12 mail_listing">
                                    <a class="pull-left p-20" href="'.$row["link"].'"><img src="'.$row["image"].'" width="100" height="100" /></a>
                                    <div class="media m-b-30 p-t-20">
                                    	<h4 class="font-bold m-t-0">Title : '.$row["title"].'</h4>
                                        <hr>
                                        <div class="media-body"><span class="media-meta pull-right">Date & Time : '.$row["date"].' - '.$row["time"].'</span></div>
                                    </div>
                                    <h4 class="font-bold m-t-0">Description </h4>
                                    <p>'.$row["content"].'</p>
                                    <hr>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title">Are you sure you want to delete this event?</h4></div>
                                                        <div class="modal-footer">
                                                        <form action="functions/del_event.php" method="post">
