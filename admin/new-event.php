                        ...
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="functions/new_event.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-5">
                                                <input type="text" class="form-control" name="link" required/> </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-5">
                                                <input type="time" class="form-control" name="time" required/> </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-3 control-label">Active</label>
                                            <div class="col-xs-5">
                                                <input type="checkbox" class="form-control" name="active" required/> </div>
                                        </div>
