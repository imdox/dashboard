...
<body>
    ...
    <section id="wrapper" class="login-register">
        <div class="login-box">
            <div class="white-box" style="box-shadow: 0px 0px 10px 5px #aaaaaa;border: 1px solid #d4d4d4;">
                <form class="form-horizontal form-material" id="loginform" action="auth.php" method="post">
