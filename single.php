...
<!-- gallery -->
	<div class="gallery">
		<div class="container">
			<h2 class="w3l_head w3l_head1">Course</h2>
			<div class="wthree_gallery_grids">
				...
				<div class="row">
					...
					'<div class="col-md-12">
						...
						<h4>'.$row["title"].'</h4>
						<br>
						<h6 style="color: orange;">'.$row["author"].' <b style="color: #000;">|</b> ('.mysqli_num_rows($query2).') Videos <b style="color: #000;">|</b> '.$row["date"].'</h6>
						<br>
					...
					?>
						...
						<h4>Videos (<?php echo mysqli_num_rows($query2); ?>)</h4>
						<br/>
